...
const Pagination: React.FC<PaginationProps> = ({ totalPages, currentPage }) => {
 ...
 className={`relative ${
    pageNumber === currentPage
      ? "z-10 inline-flex items-center bg-gray-300 p-2 text-xm text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-400"
